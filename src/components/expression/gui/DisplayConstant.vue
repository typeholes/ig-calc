<script setup lang="ts">
   ...
   import { nextTick, reactive, computed, watch, onMounted, onUpdated } from 'vue';
...
<template>
   ...
   >
      <div class="rows fullRow">
         <div class="cols wrap">
            <span
               :style="{
                  display: appState.exprBarExpanded ? 'inline' : 'block',
               }"
         ...
         <template v-if="appState.exprBarExpanded">
            <div class="cols" v-if="appState.saveEditable">
