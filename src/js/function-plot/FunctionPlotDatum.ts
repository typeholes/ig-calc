...
export function Datum(
   ...
   return {
      evalFn,
      compileFn,
      sample: linearSampler(compileFn ?? (() => evalFn)),
...
function linearSampler(compileFn: () => EvalFn): Sampler {
   return (
      xDomain: Interval,
      yRange: Interval,
      xAxisType: 'linear' | 'log',
